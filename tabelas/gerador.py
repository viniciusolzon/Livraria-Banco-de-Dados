...
# insere sem acento e tudo minusculo, na busca a gente procura sem acento e tudo minusculo entao nao tem problema
# tables['livro'].insert(titulo = "Memorias Postumas de Bras Cubas", autor = "Machado de Assis", ano_publicacao = 1881, preco = 14.99)
# tables['livro'].insert(titulo = "MeMóríâs Pòstũmas de BRAS CUBAS", autor = "MACHÂDO DÉ àSsîs", ano_publicacao = 1881, preco = 14.99)
